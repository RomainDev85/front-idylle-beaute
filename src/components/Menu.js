    ...
    return (
        <motion.section className="menu-navigation" key="menu" initial={{opacity: 0, y: -800}} animate={{opacity: 1, y: 0, transition: {duration: .3}}} exit={{opacity: 0, y: -800}}>
            <ul>
                ...
                <motion.li initial={{opacity: 0, y: 40}} animate={{opacity: 1, y: 0, transition: {delay: 0.5}}} exit={{opacity: 0, y: 40}}><HashLink smooth to="/#contact" id="contact" onClick={handleClick}><i className="far fa-star"></i>Contact</HashLink></motion.li>
            </ul>
        </motion.section>
    )
}
