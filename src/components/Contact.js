    ...
    if(loadInfo === false){
        return (
            <section className="contact" style={{backgroundImage: "url('./img/background-contact.jpg')"}} id="contact" >
                ...
                <ul className="join">
                    <li><i className="fas fa-phone"></i> {phoneNumber(infoSociety.telephone)}</li>
                    <li><a href={"https://" + infoSociety.facebook}><i className="fab fa-facebook"></i> Idylle Beauté</a></li>
